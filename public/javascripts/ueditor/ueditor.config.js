...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/file/ueditor"             //图片上传提交地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:"/file/ueditor/fetch"       //图片在线管理的处理地址
        ,imageManagerPath:""                                   //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: location.hostname                                 //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: "/file/ueditor" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/net/snapImgUp.ashx"”
        ,snapscreenPath: ""
        ,snapscreenServerPort: location.port                                   //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:"/file/ueditor"             //word转存提交地址
        ,wordImagePath:""                      //
